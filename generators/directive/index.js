...
module.exports = fountain.Base.extend({
  writing() {
    ...
    this.copyTemplate(`src/app/directive.js`, `${path}/directives/${name}/${name}.js`, props);
    this.copyTemplate(`src/app/directive.spec.js`, `${path}/directives/${name}/${name}.spec.js`, props);
  }
});
